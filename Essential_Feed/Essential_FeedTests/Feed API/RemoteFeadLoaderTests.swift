...
class RemoteFeadLoaderTests: XCTestCase {
    ...
    func test_load_deliversItemOn200HTTPResponseWithJSONitems() {
        ...
        let item1 = makeItem(
            ...
            location: "location1",
            imageURL: URL(string: "http://a-imageUrl.com")!
        )
        
        let item2 = makeItem(
            id: UUID(),
            imageURL: URL(string: "http://a-imageUrl2.com")!
        )
    ...
    private func expect(_ sut: RemoteFeedLoader, toCompleteWith expectedResult: RemoteFeedLoader.Result, when action: () -> Void, file: StaticString = #file, line: UInt = #line) {
        ...
        sut.load { receivedResult in
            switch(receivedResult, expectedResult) { //pattern matching
